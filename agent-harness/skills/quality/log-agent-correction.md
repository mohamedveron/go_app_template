...
Write an entry in `agent-harness/quality/agent-corrections.md` whenever a human corrects agent behaviour during the apply-fixes stage or a housekeeping sweep.
...
Open `harness/quality/agent-corrections.md` and prepend a new entry under `## Entries` using this format:
