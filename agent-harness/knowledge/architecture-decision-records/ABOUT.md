...
ADRs serve two purposes. Firstly they act as a record of decisions, allowing people months or years later to understand why the system is constructed in the way that it is. But perhaps even more valuable, the act of writing them helps to clarify thinking, particularly with groups of people. Writing a document of consequence often surfaces different points of view - forcing those differences to be discussed, and hopefully resolved.

A general rule is to follow an “inverted pyramid” style of writing, commonly associated with news stories. The key is to put the most important material at the start, and push details to later in the record. The most important thing to bear in mind here is brevity. Keep the ADR short and to the point - typically a single page. If there's supporting material, link to it.
...
| Document | Topic |
| -------- | ----- |
| *(none yet)* | First ADR should be written when a significant architectural decision is made (e.g. choice of auth strategy, introduction of a message bus, selection of a second database). See [`harness/skills/planning/write-adr.md`](../../skills/planning/write-adr.md) for the template. |
